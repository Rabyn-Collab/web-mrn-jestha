...
router.route('/users/login').post(validatorJoi.body(loginSchema), loginUser).all(methodNotAllowed);
router.route('/users/register').post(validatorJoi.body(registerSchema), registerUser).all(methodNotAllowed);
